...
// 또한 우리가 변수를 일일이 이름으 붙여서 다루는것이 아니라
// 배열의"몇번째" 라는 식으로 다루게 된다.
// 예를 들어 우리가 int 배열 intArray의 2번째 값을 할당할 때에는
...
// Q: 그렇다면 크기가 5인 배열의 인텍스 범위는? A: 0부터 4
...
public class Ex01Array {
	...
	// 배열의 2번 인텍스에 45를 넣어보자
	
	intArray[2] = 45;
	
	// 배열의 2번 인데스에 할당된값을 출력해보자
	System.out.println(intArray[2]);
	...
	// 참조형 데이터타입의 배열인 strintArray의 값을 출력해보자
	for(int i =0; i < stringArray.length; i++) {
	    System.out.printf("stringArray[%d]: %s\n", i, stringArray[i]);
	}
	// 우리가 참조한 데이터타입의 배열만 초기화하면
	// 각 인덱스에 String은 null 상태가 된다.
