...
public class Ex12_do_Write_Static_Menu {
	...
	while (true) {
	    switch (Ex12_do_Write_Static_Menu.displayMenu()) {
	    case 1:
		Ex12_do_Write_Static_Menu.inputRecord();
		break;
	    case 2:
		Ex12_do_Write_Static_Menu.deleteRecord();
		break;
	    case 3:
		Ex12_do_Write_Static_Menu.sortRecord();
		break;
	    case 4:
