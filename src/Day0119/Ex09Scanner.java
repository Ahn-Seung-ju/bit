...
// Scanner 클래스의 변수는
// 자바의 각종 입력을 처리한다.
// 그 중에서 키보드 입력 처리를 배워보자

// 단, Scanner 클래스는 자바에서 제공해주지만 기본 라이브러리에 포함되지
// 않으므로, 우리가 사용하려면 반드시 우리의 클래스애 "수입" 해와야 한다.
// 수입 방법은 import java.util.Scanner 라고 적어야한다. 
...
public class Ex09Scanner {
	...
	// 2. double을 입력 받을 대에는 Scanner 변수의
	...
	// 버퍼 메모리에 enter가 남아있어 "" 형태로 문자에 name이 들어가진다.
