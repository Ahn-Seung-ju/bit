...
ex)main(String[] args) >> 함수 >> 안에 모든변수는 사용시 초기화
...
그때 클래스에서 static 자원이 있다면 그 자원을 memory에 (road)올린다.
 */
...
class Variable {
    ...
    //    ---이 클래스 언제 만들었고 어떤 자원을 import하고 있고 변수 몇개 .... 기술....
    //    ---이 클래스 안에 static variable(변수) 또는 static method(함수) 있으면
    //    ---이 녀석 memory (class area)에 올려 놓는다.
    //    클래스가 로딩될 떄 생성되고 프로그램이 종료될 때 소멸
}
